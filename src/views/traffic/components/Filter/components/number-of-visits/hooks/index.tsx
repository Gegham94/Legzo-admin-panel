  ...
  const isInputsEmpty = computed(() => {
    switch (radioValue.value) {
      ...
      case "is_greater_than":
        ...
        selectIsBetweenToValue.value = 1;
        params.value = {
          isGreaterThan: [selectIsGreaterThanValue.value],
          key: "is greater than"
        };
        break;
      case "is_greater_or_equal":
        ...
        selectIsBetweenToValue.value = 1;
        params.value = {
          isGreaterOrEqual: [selectIsGreaterOrEqualValue.value],
      ...
      case "is_less_than":
        ...
        selectIsBetweenToValue.value = 1;
        params.value = {
          isLessThan: [selectIsLessThanValue.value],
          key: "is less than"
        };
        break;
      case "is_less_or_equal":
        ...
        selectIsBetweenToValue.value = 1;
        params.value = {
          isLessOrEqual: [selectIsLessOrEqualValue.value],
