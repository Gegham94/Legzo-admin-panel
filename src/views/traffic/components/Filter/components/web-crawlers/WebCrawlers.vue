...
import { useWebCrawlersHooks } from "./hooks";
...
<template>
  <div class="filter">
    ...
    >
      ...
      >
        <svg-icon
          :name="hoveringOnFilter ? 'cross' : 'crawlers'"
    ...
    <div class="content-wrapper" v-show="filter.isOpen">
      <div class="content-wrapper_header">
        <div class="title">
          <svg-icon name="crawlers" class="title-icon" />
          <div class="title-text">
            <strong>Web crawlers</strong>
          </div>
        </div>
      ...
      <div class="content-wrapper_body">
        <el-radio-group v-model="radioValue" class="radio-group">
          <el-radio
            label="show_web_crawlers"
            size="large"
            v-model="selectShowOnlyWebCrawlersValue"
            >Show only web crawlers</el-radio
          >
          <el-radio
            label="exclude_web_crawlers"
            size="large"
            v-model="selectExcludeWebCrawlersValue"
            >Exclude web crawlers</el-radio
          >
        </el-radio-group>
      </div>
